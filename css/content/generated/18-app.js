(() => {
  ...
  function GradesPopup({ className, openPopup }) {
    let panelIconColor = "currentColor";
    return /* @__PURE__ */ k("div", { className }, /* @__PURE__ */ k("a", { className: "widget-popup-close-button", onClick: () => openPopup(null) }, /* @__PURE__ */ k("svg", { width: svgSize, height: svgSize, viewBox: "0 0 1024 1024", xmlns: "http://www.w3.org/2000/svg" }, /* @__PURE__ */ k("path", { fill: "currentColor", d: "M195.2 195.2a64 64 0 0 1 90.496 0L512 421.504 738.304 195.2a64 64 0 0 1 90.496 90.496L602.496 512 828.8 738.304a64 64 0 0 1-90.496 90.496L512 602.496 285.696 828.8a64 64 0 0 1-90.496-90.496L421.504 512 195.2 285.696a64 64 0 0 1 0-90.496z" }))));
  }
  function Grades({ widgetId, moveWidget: moveWidget2, openPopup }) {
  ...
  function MainContent() {
    ...
    return /* @__PURE__ */ k("div", null, /* @__PURE__ */ k("div", { className: "widgets-grid" }, widgets.map(renderWidget)), /* @__PURE__ */ k("div", { ref: popupContainerRef, className: "popups-container" }, /* @__PURE__ */ k(GradesPopup, { openPopup: setOpenPopupId, className: `widget-popup ${openPopupId === "grades" ? "open" : ""}` })));
  }
